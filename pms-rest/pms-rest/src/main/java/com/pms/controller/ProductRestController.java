...
@ApiOperation("Featches the details of specific product with given id from Database")
...
@ApiOperation("Featches the details of specific product with given manufacturer from Database")
...
@ApiOperation("Add new product details to Database")
